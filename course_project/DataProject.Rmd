...
## Assignment overview  
&nbsp;  
**Your project this semester is to (1)** clean and organize a 'messy' data set, **(2)** prepare metadata describing the resulting 'clean' data, and **(3)** prepare a data managment plant for your thesis research. The assignment is **due is due 30 April 2021** by 5 pm and has a **total value of `r total_points` points.**
