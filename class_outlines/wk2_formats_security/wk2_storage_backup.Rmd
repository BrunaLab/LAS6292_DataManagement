...
1. **UF Guides:** 
    ...
    * [Data Classifications for Confidentiality & Security](https://it.ufl.edu/policies/information-security/data-classification-policy/)
2. **Overview of 'Checksums' and Checksum Calculators**

    * [Fisher, Tim. What Is a Checksum? (updated 15 April 2020)](https://www.lifewire.com/what-does-checksum-mean-2625825).
...
5. **UF-based Storage Options**
    ...
    * [Free UF Dropbox for Education](https://education.ufl.edu/educational-research/9729), UF Dropbox [FAQs](https://cloud.it.ufl.edu/uf-dropbox/frequently-asked-questions/), and [How advisors can submit request for students to get a Dropbox account](https://cloud.it.ufl.edu/media/clouditufledu/How-to-Obtain-Access-to-UF-Dropbox-for-Education.pdf)  
    ...
    * UF Research Computing managed storage: [Paid, for very large data volumes or data data required extra security protection due to privacy restrictions, etc.](https://www.rc.ufl.edu/help/getting-started/storage/)
...
3. **Backup Services**
    * NY Times *Wirecutter* [Review and recommendations of backup services](https://www.nytimes.com/wirecutter/reviews/best-online-backup-service/); their recommendation was [SpiderOak](https://spideroak.com/).
