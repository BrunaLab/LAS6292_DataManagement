...
1. Prepare a file documenting your data organization structure so you can share it with team members (or look at it years later when looking for something). These can be `'readme'` files as needed for each folder. The `'readme'` file might include such things as explanations of naming conventions and how the structure of the directory relates to the structure of the project.
