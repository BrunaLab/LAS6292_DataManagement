...
* to keep track of progress, we will try the following: raise hand = I need help, thumbs up = I'm good.
* steps to coding: map out what needs to be done. I do it on paper
* map out on a .R
* add key info: session info(), name and what for, etc.
* include "checks"
