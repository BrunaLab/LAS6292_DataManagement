...
3. More advanced users comfortable with R can also look into [Data Curator](https://github.com/qcif/data-curator), with which you can create and edit tabular data from scratch or from a template, open Microsoft Excel and CSV files, and automatically correct common problems found in these and other file types. 
