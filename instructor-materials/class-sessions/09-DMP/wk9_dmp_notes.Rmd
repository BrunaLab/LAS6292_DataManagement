...
* NSF General: [Mauna Loa example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/course-materials/class-sessions/09-DMP/example_dmps/DMP_MaunaLoa_Formatted.pdf)
* NSF General: [Rio Grande example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/course-materials/class-sessions/09-DMP/example_dmps/Repository%20selection%20exercise%20Data%20One%20Geosciences%20DMP.pdf)
* NSF DEB: [Emilio Bruna Heliconia example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/course-materials/class-sessions/09-DMP/example_dmps/DataManagementPlan.pdf)
