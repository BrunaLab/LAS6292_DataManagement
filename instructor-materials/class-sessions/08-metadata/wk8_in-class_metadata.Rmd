...
- \fancyhead[R]{Metadata in-class work, p. \thepage} 
...
b. **Metadata template for Biophysical Sciences**: {{% staticref "instructor-materials/class-sessions/07-metadata/ICPSR_Metadata.txt" "newtab" %}}[.txt format]{{% /staticref %}} or {{% staticref "instructor-materials/class-sessions/07-metadata/ICPSR_Metadata.Rmd" "newtab" %}}[.Rmd format]{{% /staticref %}}(Table 1 from Michener et al. 1997).
