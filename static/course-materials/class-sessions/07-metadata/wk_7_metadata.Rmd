...
Today's session is an opportunity to start drafting the metadata for your project. Although there are links below for metadata tools that will build your metadata in machine-readable XML schema, for this class a .txt file with information on the relevant Class Descriptors (*sensu* Michener 1997) is sufficient. To save you time, I have provided text files with all of the headings/subheadings recommended for social science data and ecvological data; you can simply delete any that are not relevant. Note that Table 1 from Michener is much more comprehensive, and provides much more information on how to make sure the metadata are useful.  
...
1. [Required Metadata for Social Sciences] (available on course github repo in .txt or .Rmd format) 

<!-- {{% staticref "course-materials/class-sessions/07-metadata/ICPSR_Metadata.txt" "newtab" %}}[Download in .txt format]{{% /staticref %}} | {{% staticref "course-materials/class-sessions/07-metadata/ICPSR_Metadata.Rmd" "newtab" %}}[Download in .Rmd format]{{% /staticref %}} -->

2. Table 1 from Michener et al. 1997 (available on course github repo in .txt or .Rmd format) 

<!-- {{% staticref "course-materials/class-sessions/07-metadata/Michener_Table1.txt" "newtab" %}}[Download in .txt format]{{% /staticref %}} | {{% staticref "course-materials/class-sessions/07-metadata/Michener_etal_1997_Table1.Rmd" "newtab" %}}[Download in .Rmd format]{{% /staticref %}} -->
