...
### **1. Intro to OR** (`r part_1` min)

### **2. Working with OR**  (`r part_2` min)  

### **3. Filtering and Sorting** (`r part_3` min)
     
### **4. Break** (`r snack_break` min)

### **5. Examining Numbers** (`r part_4` min)

### **6. Using Scripts, Exporting, and Saving**  (`r part_5` min)  

### **7. Wrap-up, Questions**  (`r part_6` min)  

## **8. Assignment** (`r time_remain` min)
