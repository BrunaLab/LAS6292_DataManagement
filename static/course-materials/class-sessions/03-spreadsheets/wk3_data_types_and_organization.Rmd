...
## **Breakout 1 (`r breakout1` min) **

Take a look at these these spreadsheet files and how the data are organized. 
...
3. Dates (or things that look like dates) are especially problematic in Excel. Open the file [`dates.xlsx`](./course-materials/03-spreadhseets/examples/dates.xlsx) and do the following:

blogdown::shortcode{{% staticref "course-materials/03-spreadhseets/examples/dates.xlsx" "newtab" %}}[`dates.xlsx`]{{% /staticref %}}
...
# decide if should be included or comment out
