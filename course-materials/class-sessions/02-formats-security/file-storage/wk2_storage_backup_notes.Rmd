...
- \fancyhead[R]{Data Storage and Backup Notes, p. \thepage} 
...
* for very large data volumes or data data required extra security protection due to privacy restrictions, etc. seek the assistance of [UF Research Computing](https://www.rc.ufl.edu/about/our-services/storage-resources/)

## Storage and backup for very large volumes of data (multiple TB)

* [Cyverse](cyverse.org/about)
* [Amazon Web Services (AWS) S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingBucket.html)
* [UF Research Computing](https://www.rc.ufl.edu/about/our-services/storage-resources/)
* [Open Storage Network](https://www.openstoragenetwork.org/)   
* [Argonne Leadership Computing Facility](https://alcf.anl.gov/)
* [Globus](https://www.globus.org/)
* Uploading large files to Google drive: [tutorial blog post](https://massive.io/how-to/upload-large-files-google-drive-quickly/)

## Tools for File Syncing
* [MacDropAny (macOS)](https://www.macupdate.com/app/mac/37029/macdropany)
* [MultCloud](https://www.multcloud.com/)
* Dropbox (use [via UF](https://it.ufl.edu/services/dropbox-for-education) for research, teaching)
* Google Drive (use [via UF](https://cloud.it.ufl.edu/collaboration-tools/g-suite/) for research, teaching)
...
* [IFTTT and others](http://tinyurl.com/y9bz8suj)
...
**_These services have some advantages:_**  
...
**_However, they are commercial services, and hence have a number of potential drawbacks: _** 
...
**_Some advantages of these are:_**
...
**_But they too have some drawbacks_**  
