...
# cat(txt[1])
#~/Dropbox (UFL)/Teaching/LAS 6292 - Data Collection & Management/LAS6292_DataManagement/content/course-materials/class-sessions/13-automated-data-extraction/austin_example_text_extract_r
...
text <- tesseract::ocr("./content/course-materials/class-sessions/13-automated-data-extraction/austin_example_text_extract_r/IMG_0074.JPG", engine = "por")
cat(text)
...
files <- list.files(path = "./content/course-materials/class-sessions/13-automated-data-extraction/austin_example_text_extract_r/austin", pattern = "*.JPG", full.names = T)
